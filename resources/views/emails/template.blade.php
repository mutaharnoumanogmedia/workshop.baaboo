...
<body
    ...
    <table class="wrapper" width="100%" cellpadding="0" cellspacing="0" role="presentation"
        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%; background-color: #fafbfb; margin: 0; padding: 0; width: 100%;">
        <tr>
            <td align="center"
                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="{{ url('/') }}"
                                ...
                                @isset($brand)
                                    <img src="{{ $brand ? env('STORAGE_URL') . '/' . $brand->logo_path : 'https://login.baaboo.com/assets/images/baaboo-logo-black-orange.png' }}"
                                        class="logo" alt="baaboo Logo"
                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100%; border: none; height: 48px; max-height: 48px;">
                                @else
                                    <img src="https://login.baaboo.com/assets/images/baaboo-logo-black-orange.png"
                                        class="logo" alt="baaboo"
                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100%; border: none; height: 48px; max-height: 48px;" />
                                @endisset
                    ...
                    <tr>
                        <td class="body" width="100%" cellpadding="0" cellspacing="0"
                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%; background-color: #fafbfb; border-bottom: 1px solid #fafbfb; border-top: 1px solid #fafbfb; margin: 0; padding: 0; width: 100%; border: hidden !important;">
