...
if (!function_exists('demoWorkshops')) {
    function demoWorkshops(): array
    {
        return [
            'autogenic-training' => [
...
Route::get('/my-workshops', function () {
    $workshops = array_values(demoWorkshops());
    return view('workshops.index', compact('workshops'));
});

if (!function_exists('prepareModuleContext')) {
    function prepareModuleContext(array $workshop, array $module): array
    {
...
Route::get('/workshop/{id}', function (string $id) {
    ...
    return view('workshops.show', [
        'workshop' => $workshop,
        'module' => prepareModuleContext($workshop, $firstModule),
        'modules' => $workshop['modules'],
    ]);
});

Route::get('/workshop/{id}/module/{moduleId}', function (string $id, string $moduleId) {
    $workshops = demoWorkshops();
    $workshop = $workshops[$id] ?? null;
    abort_if(is_null($workshop), 404);
    ...
    return view('workshops.show', [
        'workshop' => $workshop,
        'module' => prepareModuleContext($workshop, $module),
        'modules' => $workshop['modules'],
    ]);
});
